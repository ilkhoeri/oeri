...
export type CssVars<Variable extends string = CssVariable> = CssVariables<Variable> | (() => CssVariables<Variable>) | CssVars<Variable>[];
export type CssVarsProp<Variable extends string = CssVariable> = CssVars<Variable> | CssVars<Variable>[];

type Style = Properties | (() => Properties);
export type Properties = Record<string, any>;
export type StyleValue = Style | Style[] | StyleValue[] | undefined;

export function getStyleObject(style: StyleValue | undefined): CSSProperties {
