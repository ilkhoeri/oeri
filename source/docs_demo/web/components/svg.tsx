...
export function Demo() {
  const { numb: size, str: color,...props } = __docs_demo.useDemo({ Str: getRandomColor(), Numb: 16 });
  return (
    <>
    <__docs_demo.area className="!flex-row gap-4">
      <LogoIcon size={size} color={color} />
      <FileIcon size={size} color={color} arrow="top-right" />
    </__docs_demo.area>
    <__docs_demo.controls>
    <__docs_demo.setRange label="size" value={size} setNumb={props.setNumb} min="8" max="64" />
