...
const classes = {
  root: merge("grid grid-flow-row gap-4 pt-12 [--pd:.25rem] md:grid-flow-col md:grid-cols-2 md:gap-8 md:[--pd:.5rem] xl:gap-9 xl:[--pd:1rem]"),
  ...
  wrap: merge("inline-flex items-center gap-1 text-blue-500 transition-colors group-hover/link:text-blue-600"),
