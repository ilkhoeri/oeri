...
const BreadcrumbList = React.forwardRef<
  HTMLOListElement,
  React.ComponentPropsWithoutRef<"ol"> & Unstyled
...
const BreadcrumbItem = React.forwardRef<
  HTMLLIElement,
  React.ComponentPropsWithoutRef<"li"> & Unstyled
>(({ unstyled, className, ...props }, ref) => (
  <li
    ref={ref}
...
const BreadcrumbPage = React.forwardRef<
  HTMLSpanElement,
  React.ComponentPropsWithoutRef<"span"> & Unstyled
>(({ unstyled, className, ...props }, ref) => (
  <span
    ref={ref}
    role="link"
...
const BreadcrumbSeparator = ({
  ...
  <li role="presentation" aria-hidden="true" {...props}>
    {children || (Icon && <Icon />) || title || (
      <IconSeparator separator={separator} />
    )}
  </li>
);
...
const BreadcrumbEllipsis = ({
  ...
  className,
  ...props
}: React.ComponentProps<"span"> & Unstyled) => (
  <span
    role="presentation"
    aria-hidden="true"
    aria-label="More"
