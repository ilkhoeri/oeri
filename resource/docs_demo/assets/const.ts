...
export const STATIC_VARIANTS = ["filled", "light", "outline", "transparent", "white", "default"] as const;
export const INTERACTIVE_VARIANTS = ["default", "filled", "light", "outline", "subtle", "transparent", "white"] as const;
