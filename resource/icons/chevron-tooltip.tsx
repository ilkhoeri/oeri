...
export function Icon({ viewBox = "0 0 24 9.6", ...props }: SvgProps) {
  return (
    <Svg currentFill="fill" ratio={{ h: 1.5 }} {...{ viewBox, ...props }}>
      ...
      <path data-arrow="border" d="m20.64.96l-6.4,6.56c-1.28,1.28-3.2,1.28-4.48,0L3.36.96C2.72.32,1.92,0,1.12,0H0C0,.64.48,1.12,1.12,1.12s1.12.16,1.44.64l6.4,6.56c.8.8,1.92,1.28,3.04,1.28s2.24-.48,3.04-1.28l6.4-6.56c.32-.32.96-.64,1.44-.64S24,.64,24,0h-1.12C22.08,0,21.28.32,20.64.96Z" />
    </Svg>
  );
}
