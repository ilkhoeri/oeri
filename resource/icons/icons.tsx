...
export function BrandGithubFillIcon({ role = "img", "data-animation": dA, ...props }: SvgProps<{ ["data-animation"]?: boolean }>) {
  return (
...
export function DeviceImacIcon(props: SvgProps) {
  return (
    <Svg {...props} currentFill="fill">
      <path d="M4.25 3A2.25 2.25 0 0 0 2 5.25v10.5A2.25 2.25 0 0 0 4.25 18H9.5v1.25c0 .69-.56 1.25-1.25 1.25h-.5a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5h-.5c-.69 0-1.25-.56-1.25-1.25V18h5.25A2.25 2.25 0 0 0 22 15.75V5.25A2.25 2.25 0 0 0 19.75 3zM13 18v1.25c0 .45.108.875.3 1.25h-2.6c.192-.375.3-.8.3-1.25V18zm-9.5-3.5h17v1.25a.75.75 0 0 1-.75.75H4.25a.75.75 0 0 1-.75-.75z" />
    </Svg>
  );
}
export function DeviceMobileIcon(props: SvgProps) {
  return (
    <Svg {...props} currentFill="fill">
      <path d="M15.75 2A2.25 2.25 0 0 1 18 4.25v15.5A2.25 2.25 0 0 1 15.75 22h-7.5A2.25 2.25 0 0 1 6 19.75V4.25A2.25 2.25 0 0 1 8.25 2zm-2.5 16h-2.5a.75.75 0 0 0 0 1.5h2.5a.75.75 0 0 0 0-1.5" />
    </Svg>
  );
}
export function DeviceTabletIcon(props: SvgProps) {
  return (
    <Svg {...props} currentFill="fill">
      <path d="M19.749 4a2.25 2.25 0 0 1 2.25 2.25v11.502a2.25 2.25 0 0 1-2.25 2.25H4.25A2.25 2.25 0 0 1 2 17.752V6.25A2.25 2.25 0 0 1 4.25 4zM13.75 15.5h-3.5a.75.75 0 0 0 0 1.5h3.5a.75.75 0 1 0 0-1.5" />
    </Svg>
  );
}
