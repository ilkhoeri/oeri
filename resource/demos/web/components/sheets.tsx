...
import { Button, buttonStyle, buttonVariants } from "@/ui/button";
...
function AccordionDemo(props: SheetsProps) {
  return (
    <Sheets {...props} variant="accordion" defaultOpen="accessibility" className="w-full max-w-96 rounded-2xl border px-6">
      {data.map((i, index) => (
...
function DialogDemo() {
  return (
    <Sheets variant="dialog">
      <SheetsTrigger>
        <Typography el="span" data-labelopen="Open Dialog" data-labelclosed="Close Dialog" className="group-data-[state=closed]/st:before:content-[attr(data-labelopen)] group-data-[state=open]/st:before:content-[attr(data-labelclosed)]" />
      </SheetsTrigger>
...
function DrawerDemo(props: SheetsDrawerProps) {
  return (
    <Sheets {...props} variant="drawer">
      <SheetsTrigger id="drawer" className={buttonVariants({ variant: "outline" })}>
        <Typography el="span" data-labelopen="Open Drawer" data-labelclosed="Close Drawer" className="group-data-[state=closed]/st:before:content-[attr(data-labelopen)] group-data-[state=open]/st:before:content-[attr(data-labelclosed)]" />
      </SheetsTrigger>
...
function DrawerDemoNested() {
  return (
    <Sheets variant="drawer" multipleOpen>
      <Sheets.Trigger id="drawer-demo-1" className={buttonVariants({ variant: "outline" })}>
        Open Drawer 1
      </Sheets.Trigger>
  ...
  return (
    <Sheets {...props} variant="dropdown">
      <Sheets.Trigger id="dropdown-demo" className="m-auto">
        <span data-labelopen="Dropdown" data-labelclosed="Dropdown" className="group-data-[state=closed]/st:before:content-[attr(data-labelopen)] group-data-[state=open]/st:before:content-[attr(data-labelclosed)]" />
      </Sheets.Trigger>
