...
const codes = {
  ...
  configurator:
    '"use client";\nimport { useState } from "react";\nimport { Checker } from "@/ui/checker";\n\nexport function CheckerDemo() {\n  const [checked, setChecked] = useState(false);\n  return <Checker{{props}} onLabel="ON" offLabel="OFF" defaultChecked checked={checked} onChange={event => setChecked(event.currentTarget.checked)} />;\n}',
  changeIconLabels:
...
const propType: ConfiguratorControlOptions[] = [
  { prop: "type", type: "select", initialValue: "switch", libraryValue: "switch", data: ["switch", "checkbox", "radio"] },
  { prop: "labelPosition", type: "select", initialValue: "right", libraryValue: "right", data: ["left", "right"] }
];
...
const changeIconLabels: DataTrees = {
  ...
  centered: true,
  controls: [
    { prop: "type", type: "select", initialValue: "switch", libraryValue: null, data: ["switch", "checkbox", "radio"] },
    { prop: "labelPosition", type: "select", initialValue: "right", libraryValue: "right", data: ["left", "right"] }
  ]
};
