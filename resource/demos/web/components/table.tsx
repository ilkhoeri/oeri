...
import { Table, TableBody, TableCaption, TableData, TableHead, TableHeader, TableRow, dataRenderer, type TableDataProps, type TableProps } from "@/ui/table";
...
const configurator: DataTrees = {
  ...
  controls: [
    ...
    { prop: "variant", type: "select", initialValue: "vertical", libraryValue: "vertical", data: ["vertical", "horizontal"] },
