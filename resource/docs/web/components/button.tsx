...
export const buttonVariants = cvx({
  ...
  variants: {
    variant: {
      ...
      outline:
        "bg-background text-muted-foreground focus-visible:ring-muted-foreground/35 border [@media(hover:hover)]:hover:bg-muted/50 [@media(hover:hover)]:hover:text-color",
    ...
    color: {
      ...
      "gradient-orange":
        "bg-[linear-gradient(-180deg,#FF7E31,#E62C03)] text-white disabled:[--spinner-color:white] border-[#E62C03] [@media(hover:hover)]:hover:bg-[#d4d3d5]",
      "outline-base":
        "outline-2 outline outline-slate-500 bg-slate-500/20 text-slate-600 disabled:[--spinner-color:#475569] [@media(hover:hover)]:hover:bg-slate-600/20",
      "outline-indigo":
        "outline-2 outline outline-indigo-500 bg-indigo-500/20 text-indigo-600 disabled:[--spinner-color:#4f46e5] [@media(hover:hover)]:hover:bg-indigo-600/20",
      "outline-teal":
        "outline-2 outline outline-teal-500 bg-teal-500/20 text-teal-600 disabled:[--spinner-color:#0d9488] [@media(hover:hover)]:hover:bg-teal-600/20"
    }
  },
  defaultVariants: {
    variant: "default",
